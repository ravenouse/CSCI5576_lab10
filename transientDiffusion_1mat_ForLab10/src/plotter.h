...
void plot(string descriptor, VD &field, int timeIdx, mpiInfo &myMPI, string plt_out_path)
  {
    ...
    string filename = plt_out_path + descriptor + "_" + myPE_str.str() + "_" + Idx_str.str() + ".plt";
